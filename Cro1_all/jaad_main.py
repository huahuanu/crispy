...
def main():
    ...
    parser.add_argument('--monitor_acc', type=bool, default=False, help='default monitor mode to val_acc[Default] or val_loss.')
    ...
    parser.add_argument('--dff', type=int, default=256, help='hidden dimension')
