...
class JaadDataset(data.Dataset):
    def __init__(self, data_set, data_path, set_path, balance=False, transforms=None, bh='all'):  #beh
    ...
    def __getitem__(self, item):
        ...
        vel = torch.from_numpy(np.tile(ped_data['vehicle_act'], [1, 2]).transpose(1, 0)).float().contiguous()[:, -32:]
