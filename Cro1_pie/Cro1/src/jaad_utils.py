    ...
    def run(self, args):
        ...
        if args.train:
            if not args.debug:
                ...
                train_data = [[torch.randn(size=(args.batch_size, args.time_scale, args.bbox_size)),
                               torch.randn(size=(args.batch_size, args.vel_size, args.time_scale)),
                               torch.tensor([[1] * args.batch_size])]]
                val_data = [[torch.randn(size=(args.batch_size, args.time_scale, args.bbox_size)),
                             torch.randn(size=(args.batch_size, args.vel_size, args.time_scale)),
                             torch.tensor([[1] * args.batch_size])]]
        ...
        if args.test:
            if not args.debug:
                ...
                test_data = [[torch.randn(size=(args.batch_size, args.time_scale, args.bbox_size)),
                              torch.randn(size=(args.batch_size, args.vel_size, args.time_scale)),
                              torch.tensor([[1] * args.batch_size])],
                             [torch.randn(size=(args.batch_size, args.time_scale, args.bbox_size)),
                              torch.randn(size=(args.batch_size, args.vel_size, args.time_scale)),
