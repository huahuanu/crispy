import argparse
from src.jaad_utils import TrainInterface
...
def main():
    ...
    parser.add_argument('--device', type=str, default='cuda:1', help='choose device')
    ...
    parser.add_argument('--monitor_acc', type=bool, default=True,
    ...
    parser.add_argument('--drop_rate', type=float, default=0.15, help='drop rate')

    # Set dataset
    parser.add_argument('--time_scale', type=int, default=16, help='time scale')
