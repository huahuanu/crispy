...
def main():
    ...
    # basic sets for learning.
    parser.add_argument('--seed', type=int, default=42, help='seed')
    parser.add_argument('--batch_size', type=int, default=16, help='batch size') #
    parser.add_argument('--num_workers', type=int, default=8, help='number of workers')
    parser.add_argument('--lr', type=float, default=5e-4, help='learning rate') #
    parser.add_argument('--epochs', type=int, default=400, help='number of epochs')
    parser.add_argument('--save_name', type=str, default='pie', help='weight path')
    parser.add_argument('--data_path', type=str, default='../data/PIE_dataset/', help='dataset path')
    parser.add_argument('--set_path', type=str, default='../data/PIE/', help='dataset set path')
    ...
    parser.add_argument('--monitor_acc', type=bool, default=False,
                        help='default monitor mode to val_acc[Default] or val_loss.')
    ...
    # Set dataset
    parser.add_argument('--time_scale', type=int, default=8, help='time scale')
    ...
    # Call TrainInterface
    call_cell = TrainInterface(dataset='PIE', args=args)
