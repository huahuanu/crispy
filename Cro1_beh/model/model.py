...
class Net(nn.Module):
    def __init__(self, args):
        ...
        self.conv_bbox = nn.Sequential(nn.Conv1d(args.bbox_size, args.d_model, kernel_size=1, padding=0),
                                       nn.BatchNorm1d(args.d_model), nn.ReLU())
        self.conv_vel = nn.Sequential(nn.Conv1d(args.vel_size, args.d_model, kernel_size=1, padding=0),
                                      nn.BatchNorm1d(args.d_model), nn.ReLU())
